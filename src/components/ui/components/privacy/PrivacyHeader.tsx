    ...
    return (
        <div className="w-full lg:pt-[180px]  pt-32 lg:container ">
            ...
            <div className="  lg:pb-12 pb-8">
                ...
                <h1 className="lg:text-[50px] text-[32px] font-normal text-content1 lg:mb-6 mb-3"> <span className="font-bold"> Privacy  </span>   <span className="font-bold">Policy </span> </h1>
            ...
            <div className=" w-full lg:h-[530px] h-[400px]">
                <img
                    ...
                    className="object-cover  lg:h-[530px] h-[400px] w-full rounded-xl"
                />

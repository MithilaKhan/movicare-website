        ...
        <div className=' lg:h-[1097px] h-[700px]' style={{
            ...
            <div className=' lg:pt-[120px] pt-28 flex items-start justify-center h-full'>
                <div className=' flex flex-col items-center justify-center gap-4'>
                    ...
                    <button  onClick={() => router.push("/select-service")} className=' flex items-center text-sm justify-center font-medium bg-white gap-2 text-primary  rounded-full py-4 px-6'> <span> Check Rates & Book Now</span>
